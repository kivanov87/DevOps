...
docker build -t ivanovka87/hw3-web -f /vagrant/application/Dockerfile.web /vagrant/application/.

echo "* Build the db image ..."
docker build -t ivanovka87/hw3-db -f /vagrant/application/Dockerfile.db /vagrant/application/.

echo "* Push the web image ..."
docker image push ivanovka87/hw3-web

echo "* Push the db image ..."
docker image push ivanovka87/hw3-db
